...
{
    [Cmdlet(VerbsCommon.Get, CommandUtilities.MODULE_PREFIX + "DotNetData")]
    public class GetPSCompatibilityDotNetData : Cmdlet
    {
        protected override void EndProcessing()
        {
            ...
            {
                WriteObject(platformInfoCollector.GetDotNetData());
            }
        }
    }
}