Import-Module $PSScriptRoot\PSCompatibilityCheck\bin\Debug\netstandard2.0\PSCompatibilityCheck.dll
...
{
    return [PSCompatibilityCheck.Serializable.CompatibilityReportData]@{
...
{
    return [PSCompatibilityCheck.Serializable.Platform.PlatformData]@{
...
function Get-MachineData
{
    ...
    return [PSCompatibilityCheck.Serializable.Platform.MachineData]@{
        Bitness = $bits
        Architecture = $arch
    }
}
...
function Get-PowerShellData
{
    ...
    return [PSCompatibilityCheck.Serializable.Platform.PowerShellData]$psData
}
...
function Get-OSData
{
    ...
    return [PSCompatibilityCheck.Serializable.Platform.OperatingSystemData]$osData
}
...
function Get-DotNetData
{
    ...
    return [PSCompatibilityCheck.Serializable.Platform.DotNetData]@{
        Runtime = $runtime
...
function Get-CoreModuleData
{
    ...
    return [PSCompatibilityCheck.Serializable.Module.ModuleData]$coreModuleData
}
...
function New-CompatibilityData
{
    ...
    return [PSCompatibilityCheck.Serializable.CompatibilityData]$compatData
}
...
function New-ModuleData
{
    ...
    begin
    {
        $dict = New-Object 'System.Collections.Generic.Dictionary[string, PSCompatibilityCheck.Serializable.Modules.ModuleData]'
    }
    ...
    process
    {
        ...
        $dict[$Module.Name] = [PSCompatibilityCheck.Serializable.Modules.ModuleData]$modData
    }
...
function New-CmdletData
{
    ...
    begin
    {
        $dict = New-Object 'System.Collections.Generic.Dictionary[string, PSCompatibilityCheck.Serializable.Modules.CmdletData]'
    }
    ...
    process
    {
        ...
        $dict[$Cmdlet.Name] = [PSCompatibilityCheck.Serializable.Modules.CmdletData]$cmdletData
    }
...
function New-FunctionData
{
    ...
    begin
    {
        $dict = New-Object 'System.Collections.Generic.Dictionary[string, PSCompatibilityCheck.Serializable.Modules.FunctionData]'
    }
    ...
    process
    {
        ...
        $dict[$Function.Name] = [PSCompatibilityCheck.Serializable.Modules.FunctionData]$functionData
    }
...
function New-ParameterData
{
    ...
    begin
    {
        $dict = New-Object 'System.Collections.Generic.Dictionary[string, PSCompatibilityCheck.Serializable.Modules.ParameterData]'
    }
    ...
    process
    {
        ...
        $dict[$Parameter.Name] = [PSCompatibilityCheck.Serializable.Modules.ParameterData]$parameterData
    }
...
function New-ParameterSetData
{
    ...
    begin
    {
        $dict = New-Object 'System.Collections.Generic.Dictionary[string, PSCompatibilityCheck.Serializable.Modules.ParameterSetData]'
    }
    ...
    process
    {
        ...
        $flags = New-Object 'System.Collections.Generic.List[PSCompatibilityCheck.Serializable.Modules.ParameterSetFlag]'
        ...
        $dict[$ParameterSet.Key] = [PSCompatibilityCheck.Serializable.Modules.ParameterSetData]$parameterSetData
    }
...
function New-AvailableTypeData
{
    ...
    return [PSCompatibilityCheck.Serializable.CompatibilityDataAssembler]::AssembleAvailableTypes($Assemblies, $TypeAccelerators)
    ...
    return [PSCompatibilityCheck.Serializable.Types.AvailableTypeData]@{
        Assemblies = $asms
...
function New-AssemblyData
{
    ...
    begin
    {
        $dict = New-Object 'System.Collections.Generic.Dictionary[string, PSCompatibilityCheck.Serializable.Types.AssemblyData]'
    }
    ...
    process
    {
        ...
        $asmData = [PSCompatibilityCheck.Serializable.Types.AssemblyData] @{
...
function New-AssemblyNameData
{
    ...
    process
    {
        ...
        [PSCompatibilityCheck.Serializable.Types.AssemblyNameData] @{
...
function New-TypeData
{
    ...
    begin
    {
        $dict = New-Object 'System.Collections.Generic.Dictionary[string, System.Collections.Generic.IDictionary[string, PSCompatibilityCheck.Serializable.Types.TypeData]]'
    }
    ...
    process
    {
        ...
        {
            $namespaceDict = New-Object 'System.Collections.Generic.Dictionary[string, PSCompatibilityCheck.Serializable.Types.TypeData]'
        ...
        $typeData = [PSCompatibilityCheck.Serializable.Types.TypeData]$typeData
...
function New-MemberData
{
    ...
    end
    {
        ...
        $methodDataDict = New-Object 'System.Collections.Generic.Dictionary[string, PSCompatibilityCheck.Serializable.Types.MethodData]'
        ...
        return [PSCompatibilityCheck.Serializable.Types.MemberData]$memberData
    }
}
...
function New-FieldData
{
    ...
    process
    {
        return [PSCompatibilityCheck.Serializable.Types.FieldData]@{
...
function New-EventData
{
    ...
    process
    {
        return [PSCompatibilityCheck.Serializable.Types.EventData]@{
...
function New-IndexerData
{
    ...
    process
    {
        ...
        return [PSCompatibilityCheck.Serializable.Types.IndexerData]@{
...
function New-PropertyData
{
    ...
    process
    {
        ...
        return [PSCompatibilityCheck.Serializable.Types.PropertyData]@{
...
function New-MethodData
{
    ...
    process
    {
        ...
        return [PSCompatibilityCheck.Serializable.Types.MethodData]@{
...
function Get-FullTypeName
{
    ...
    process
    {
        return [PSCompatibilityCheck.Serializable.CompatibilityDataAssembler]::GetFullTypeName($Type)
    }
}