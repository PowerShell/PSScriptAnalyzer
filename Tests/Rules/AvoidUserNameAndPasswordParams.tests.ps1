...
BeforeAll {
    ...
    $violations = Invoke-ScriptAnalyzer $PSScriptRoot\..\assets\AvoidUserNameAndPasswordParams.ps1 | Where-Object {$_.RuleName -eq $violationName}
    $noViolations = Invoke-ScriptAnalyzer $PSScriptRoot\..\assets\AvoidUserNameAndPasswordParamsNoViolations.ps1 | Where-Object {$_.RuleName -eq $violationName}
}
