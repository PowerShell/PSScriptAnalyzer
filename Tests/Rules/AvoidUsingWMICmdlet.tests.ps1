...
BeforeAll {
    ...
    $violations = Invoke-ScriptAnalyzer $PSScriptRoot\..\assets\AvoidUsingWMICmdlet.ps1 -IncludeRule $WMIRuleName
    $noViolations = Invoke-ScriptAnalyzer $PSScriptRoot\..\assets\AvoidUsingWMICmdletNoViolations.ps1 -IncludeRule $WMIRuleName
}
