...
BeforeAll {
    ...
    $violations = Invoke-ScriptAnalyzer $PSScriptRoot\..\assets\PSCredentialType.ps1 | Where-Object {$_.RuleName -eq $violationName}
    $noViolations = Invoke-ScriptAnalyzer $PSScriptRoot\..\assets\PSCredentialTypeNoViolations.ps1 | Where-Object {$_.RuleName -eq $violationName}
}
