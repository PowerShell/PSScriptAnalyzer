...
$script:CompatibilityTestCases = @(
    ...
    @{ Target = $script:Srv2019_7_profile; Script = "Get-Content $pshome\about_signing.help.txt | Out-Printer"; Commands = @("Out-Printer"); Version = "7.0"; OS = "Windows"; ProblemCount = 1 }
    ...
    @{ Target = $script:Srv2019_7_profile; Script = "Get-Process | Out-GridView"; Commands = @("Out-GridView"); Version = "7.0"; OS = "Windows"; ProblemCount = 1 }
    @{ Target = $script:Srv2019_7_profile; Script = "Get-Process | ogv"; Commands = @("ogv"); Version = "7.0"; OS = "Windows"; ProblemCount = 1 }
    ...
    @{ Target = $script:Srv2019_7_profile; Script = "Show-Command"; Commands = @("Show-Command"); Version = "7.0"; OS = "Windows"; ProblemCount = 1 }
    ...
    @{ Target = $script:Srv2019_7_profile; Script = 'Get-Counter "\Processor(*)\% Processor Time" | Export-Counter -Path $home\Counters.blg'; Commands = @("Get-Counter", "Export-Counter"); Version = "7.0"; OS = "Windows"; ProblemCount = 2 }
    @{ Target = $script:Srv2019_7_profile; Script = 'curl $uri'; Commands = @("curl"); Version = "7.0"; OS = "Windows"; ProblemCount = 1 }
    @{ Target = $script:Srv2019_7_profile; Script = 'Get-ChildItem ./ | Format-List'; Commands = @(); Version = "3.0"; OS = "Windows"; ProblemCount = 0 }
    ...
    @{ Target = $script:Srv2019_7_profile; Script = 'Set-Clipboard -Value "This is a test string"'; Commands = @("Set-Clipboard"); Version = "7.0"; OS = "Windows"; ProblemCount = 1 }
    ...
    @{ Target = $script:Srv2019_7_profile; Script = 'Clear-RecycleBin'; Commands = @("Clear-RecycleBin"); Version = "7.0"; OS = "Windows"; ProblemCount = 1 }
    ...
    @{ Target = $script:Srv2019_7_profile; Script = 'Get-HotFix -Description "Security*" -ComputerName "Server01", "Server02" -Cred "Server01\admin01"'; Commands = @("Get-HotFix"); Version = "7.0"; OS = "Windows"; ProblemCount = 1 }
...
$script:ParameterCompatibilityTestCases = @(
    ...
    @{ Target = $script:Srv2019_7_profile; Script = 'Get-Help "Invoke-WebRequest" -ShowWindow'; Commands = @('Get-Help'); Parameters = @('ShowWindow'); Version = "7.0"; OS = 'Windows'; ProblemCount = 1 }
