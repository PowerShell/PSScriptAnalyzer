...
BeforeAll {
    ...
    $violations = Invoke-ScriptAnalyzer $PSScriptRoot\..\assets\AvoidUsingWriteHost.ps1 | Where-Object {$_.RuleName -eq $writeHostName}
    $noViolations = Invoke-ScriptAnalyzer $PSScriptRoot\..\assets\AvoidUsingWriteHostNoViolations.ps1 | Where-Object {$_.RuleName -eq $clearHostName}
}
