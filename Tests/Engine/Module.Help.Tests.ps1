...
{
	$RequiredVersion = (Get-Module -ListAvailable $ModuleName | Sort-Object Version -Descending)[0].Version
}
...
$commands = Get-Command -FullyQualifiedModule $ms -CommandType Cmdlet, Function, Workflow  # Exclude aliases
