...
namespace Microsoft.Windows.PowerShell.ScriptAnalyzer.BuiltinRules
{
    ...
    public class PlaceOpenBrace : ConfigurableRule
    {
        ...
        /// </summary>
        public override string GetCommonName() => string.Format(CultureInfo.CurrentCulture, Strings.PlaceOpenBraceCommonName);

        /// <summary>
        /// Retrieves the description of this rule.
        /// </summary>
        public override string GetDescription() => string.Format(CultureInfo.CurrentCulture, Strings.PlaceOpenBraceDescription);
        ...
        private static string GetError(string errorString) => string.Format(CultureInfo.CurrentCulture, errorString);
        ...
        private string GetIndentation(Token[] tokens, int refTokenPos) => new String(' ', GetStartColumnNumberOfTokenLine(tokens, refTokenPos) - 1);
