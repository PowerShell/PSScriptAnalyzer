...
namespace Microsoft.Windows.PowerShell.ScriptAnalyzer.BuiltinRules
{
    ...
    public class AvoidUsingArrayList : ConfigurableRule
    {
        ...
        /// </summary>
        public override string GetCommonName() => string.Format(CultureInfo.CurrentCulture, Strings.AvoidUsingArrayListCommonName);

        /// <summary>
        /// Retrieves the description of this rule.
        /// </summary>
        public override string GetDescription() => string.Format(CultureInfo.CurrentCulture, Strings.AvoidUsingArrayListDescription);
