...
namespace Microsoft.Windows.PowerShell.ScriptAnalyzer.BuiltinRules
{
    ...
    public class PlaceCloseBrace : ConfigurableRule
    {
        ...
        /// </summary>
        public override string GetCommonName() => string.Format(CultureInfo.CurrentCulture, Strings.PlaceCloseBraceCommonName);

        /// <summary>
        /// Retrieves the description of this rule.
        /// </summary>
        public override string GetDescription() => string.Format(CultureInfo.CurrentCulture, Strings.PlaceCloseBraceDescription);
