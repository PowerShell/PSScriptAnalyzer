...
namespace Microsoft.Windows.PowerShell.ScriptAnalyzer.BuiltinRules
{
    ...
    public class UseToExportFieldsInManifest : IScriptRule
    {
        ...
        /// <returns></returns>
        public string GetError(string field) => string.Format(CultureInfo.CurrentCulture, Strings.UseToExportFieldsInManifestError, field);

        /// <summary>
        /// GetName: Retrieves the name of this rule.
        /// </summary>
        /// <returns>The name of this rule</returns>
        public string GetName() => string.Format(CultureInfo.CurrentCulture, Strings.NameSpaceFormat, GetSourceName(), Strings.UseToExportFieldsInManifestName);

        /// <summary>
        /// GetCommonName: Retrieves the common name of this rule.
        /// </summary>
        /// <returns>The common name of this rule</returns>
        public string GetCommonName() => String.Format(CultureInfo.CurrentCulture, Strings.UseToExportFieldsInManifestCommonName);

        /// <summary>
        /// GetDescription: Retrieves the description of this rule.
        /// </summary>
        /// <returns>The description of this rule</returns>
        public string GetDescription() => String.Format(CultureInfo.CurrentCulture, Strings.UseToExportFieldsInManifestDescription);
