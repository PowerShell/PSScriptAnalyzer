...
{
    /// <summary>
    /// AvoidUsingGetWMIObject: Verify that Get-WMIObject is not used
    /// </summary>
    [Export(typeof(IScriptRule))]
    public class AvoidUsingGetWMIObject : IScriptRule
    {
        /// <summary>
        /// AnalyzeScript: Verify that Get-WMIObject is not used
        /// </summary>
        ...
        {
            return string.Format(CultureInfo.CurrentCulture, Strings.NameSpaceFormat, GetSourceName(), Strings.AvoidUsingGetWMIObjectName);
        }
        ...
        {
            return string.Format(CultureInfo.CurrentCulture, Strings.AvoidUsingGetWMIObjectCommonName);
        }
        ...
        {
            return string.Format(CultureInfo.CurrentCulture, Strings.AvoidUsingGetWMIObjectDescription);
        }
