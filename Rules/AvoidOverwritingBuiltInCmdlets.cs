...
namespace Microsoft.Windows.PowerShell.ScriptAnalyzer.BuiltinRules
{
    ...
    public class AvoidOverwritingBuiltInCmdlets : ConfigurableRule
    {
        ...
        private bool ContainsReferenceFile(string directory, string reference) => File.Exists(Path.Combine(directory, reference + ".json"));
        ...
        /// </summary>
        public override string GetCommonName() => string.Format(CultureInfo.CurrentCulture, Strings.AvoidOverwritingBuiltInCmdletsCommonName);

        /// <summary>
        /// Retrieves the description of this rule.
        /// </summary>
        public override string GetDescription() => string.Format(CultureInfo.CurrentCulture, Strings.AvoidOverwritingBuiltInCmdletsDescription);
