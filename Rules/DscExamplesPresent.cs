...
[Export(typeof(IDSCResourceRule))]
    ...
    public class DscExamplesPresent : IDSCResourceRule
    {
        ...
        public string GetCommonName() => string.Format(CultureInfo.CurrentCulture, Strings.DscExamplesPresentCommonName);

        /// <summary>
        /// GetDescription: Retrieves the description of this rule.
        /// </summary>
        /// <returns>The description of this rule</returns>
        public string GetDescription() => string.Format(CultureInfo.CurrentCulture, Strings.DscExamplesPresentDescription);
