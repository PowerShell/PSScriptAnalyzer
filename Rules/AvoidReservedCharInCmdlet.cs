...
[Export(typeof(IScriptRule))]
    ...
    public class AvoidReservedCharInCmdlet : IScriptRule
    {
        ...
        public string GetName() => string.Format(CultureInfo.CurrentCulture, Strings.NameSpaceFormat, GetSourceName(), Strings.ReservedCmdletCharName);

        /// <summary>
        /// GetCommonName: Retrieves the common name of this rule.
        /// </summary>
        /// <returns>The common name of this rule</returns>
        public string GetCommonName() => string.Format(CultureInfo.CurrentCulture, Strings.ReservedCmdletCharCommonName);

        /// <summary>
        /// GetDescription: Retrieves the description of this rule.
        /// </summary>
        /// <returns>The description of this rule</returns>
        public string GetDescription() => string.Format(CultureInfo.CurrentCulture, Strings.ReservedCmdletCharDescription);
