...
namespace Microsoft.Windows.PowerShell.ScriptAnalyzer.BuiltinRules
{
    ...
    public class AvoidLongLines : ConfigurableRule
    {
        ...
        /// </summary>
        public override string GetCommonName() => string.Format(CultureInfo.CurrentCulture, Strings.AvoidLongLinesCommonName);

        /// <summary>
        /// Retrieves the description of this rule.
        /// </summary>
        public override string GetDescription() => string.Format(CultureInfo.CurrentCulture, Strings.AvoidLongLinesDescription);
        ...
        /// </summary>
        /// <returns></returns>
        private DiagnosticSeverity GetDiagnosticSeverity() => DiagnosticSeverity.Warning;
